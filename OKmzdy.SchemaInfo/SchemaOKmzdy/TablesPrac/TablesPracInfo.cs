...
namespace OKmzdy.OKmzdySchemaInfo.TablesPrac
{
    public class TablePracInfo : TableDefInfo
    {
        ...
        override public string ClassColumnName(string columnName)
        {
            Tuple<string, string>[] changeNames = new Tuple<string, string>[] {
                new Tuple<string, string>("ppracovnik_id", "pracovnik_id")
            };
            return PropertyName(changeNames, columnName);
        }
    ...
    public class TablePracVyberAggr : TableDefInfo
    {
        ...
        public static TableDefInfo GetDictValue(string lpszOwnerName, string lpszUsersName)
        {
            return new TablePracVyberAggr(lpszOwnerName, lpszUsersName);
        }
        public TablePracVyberAggr(string lpszOwnerName, string lpszUsersName) :
